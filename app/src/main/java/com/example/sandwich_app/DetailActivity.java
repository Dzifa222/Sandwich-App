package com.example.sandwich_app;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView mAlsoKnownAsLabelTextView, mAlsoKnownAsTextView, mIngredientsLabelTextView, mIngredientsTextView, mOriginLabelTextView, mOriginTextView, mDescriptionTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAlsoKnownAsLabelTextView = findViewById(R.id.also_know_label_tv);
